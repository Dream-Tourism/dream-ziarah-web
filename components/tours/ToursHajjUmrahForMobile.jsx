...
const ToursHajjUmrahForMobile = ({
  searchLocation,
  onMobileTourDataAvailable,
}) => {
  ...
  useEffect(() => {
    dispatch(
      addItemsCount(
        `${filteredTours?.length} packages available for Hajj and Umrah`
      )
    );
...
export default ToursHajjUmrahForMobile;
